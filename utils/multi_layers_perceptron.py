...
class MultiLayerPerceptron(nn.Module):
    ...
    def __init__(self, mlp_configurator: MultiLayersPerceptronConfigurator):
        ...
        self.output_layer = Layer(input_size=mlp_configurator.hidden_layers[-1], output_size=mlp_configurator.output_size, activation=mlp_configurator.activation_output)
    ...
    def __build_hidden_layers(self, hidden_layers: list, hidden_activation: str, input_size: int):
        ...
        for hidden_size in hidden_layers:
            hidden_layers_modules.append(Layer(input_size=previous_hidden_size, output_size=hidden_size, activation=hidden_activation))
